...
@contract_router.post("/contract", response_model=ContractRequestResponse, status_code=status.HTTP_201_CREATED)
async def create_contract(contract: ContractRequestResponse,
